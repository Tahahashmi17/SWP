              ...
              <div className="p-4 border-t border-white/10 space-y-3">
                ...
                {!isScreenSharing && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-accent/20 hover:bg-accent/30 text-accent rounded-lg transition-colors border border-accent/30"
                  >
                  ...
                  >
                    <label className="block">
                      <div className={`flex flex-col items-center gap-3 p-4 border-2 border-dashed border-white/20 rounded-xl hover:border-accent/50 transition-colors cursor-pointer ${
                        dragActive ? 'bg-accent/20 border-accent/50' : ''
                      }`}>
                        {isUploading ? (
